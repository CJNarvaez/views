...
$this->table->set_heading('<center>UNIDAD DE MEDIDA</center>');
...
if($nivel == '2do')
    foreach($ind as $ren)
    {
        ...
        //$indicador = $ren['descripcion_ind'];
        $this->table->add_row('<a href="'.site_url('/indicador/eval_reporta_jur/'.$ren['id_medida']).'/no_ind/'.$nivel.'"><i class="fa fa-pencil-square-o"></i> '.$ren['descripcion_medida'].'</a>');
    }
else
    foreach($ind as $ren)
    {
        $programa = $ren['descripcion_programa'];
        $indicador = $ren['descripcion_ind'];
        $this->table->add_row('<a href="'.site_url('/indicador/eval_reporta_jur/'.$ren['id_medida']).'/'.$ren['id_ind'].'/'.$nivel.'"><i class="fa fa-pencil-square-o"></i> '.$ren['descripcion_medida'].'</a>');
    }
?>
<div class="row bs-wizard" style="border-bottom:0;">
    ...
    <div class="col-xs-3 bs-wizard-step complete"><!-- complete -->
      ...
      <div class="progress"><div class="progress-bar"></div></div>
      <a href="#" class="bs-wizard-dot"></a>
      <div class="bs-wizard-info text-center">Indicador: <?php if($nivel != '2do') echo $indicador ?></div>
    </div>
